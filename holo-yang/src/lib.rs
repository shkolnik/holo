...
static YANG_EMBEDDED_MODULES: Lazy<EmbeddedModules> = Lazy::new(|| {
    hashmap! {
        ...
        EmbeddedModuleKey::new("iana-igp-algo-types", Some("2026-07-09"), None, None) =>
            include_str!("../modules/ietf/iana-igp-algo-types@2026-07-09.yang"),
        EmbeddedModuleKey::new("iana-igp-link-attr-apps", Some("2026-07-09"), None, None) =>
            include_str!("../modules/ietf/iana-igp-link-attr-apps@2026-07-09.yang"),
        EmbeddedModuleKey::new("iana-igp-metric-types", Some("2026-07-09"), None, None) =>
            include_str!("../modules/ietf/iana-igp-metric-types@2026-07-09.yang"),
        ...
        EmbeddedModuleKey::new("ietf-isis-flex-algo", Some("2026-07-11"), None, None) =>
            include_str!("../modules/ietf/ietf-isis-flex-algo@2026-07-11.yang"),
        EmbeddedModuleKey::new("ietf-isis-link-attr", Some("2026-07-11"), None, None) =>
            include_str!("../modules/ietf/ietf-isis-link-attr@2026-07-11.yang"),
